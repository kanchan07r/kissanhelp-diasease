...
if app_mode == "HOME":
    ...
    st.markdown(
        """
        <h1 style='text-align: center; color: #4CAF50;'>🌿 KissanHelp: Smart Disease Detection</h1>
    ...
    st.markdown(
        ...
        <div style="text-align: center; margin-top: 50px; font-size: 14px; color: #666;">
            ...
            <p>🌱 <strong>KissanHelp</strong> — AI-Powered Smart Farming</p>
            <p>Developed by <strong>Kanchan</strong> | Maharaja Agrasen University</p>
            <p>© 2026 KissanHelp. All rights reserved.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
...
# ── DISEASE RECOGNITION PAGE ───────────────────────────────────────────────────
    ...
    st.markdown(
        ...
        <p style='text-align: center; color: #555;'>Upload a plant image and let KissanHelp detect the disease instantly.</p>
        """,
        unsafe_allow_html=True,
    )
